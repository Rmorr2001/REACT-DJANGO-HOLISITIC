...
var chunkY7JG2JA7_js = require('./chunk-Y7JG2JA7.js');
var chunkDVVUUI3X_js = require('./chunk-DVVUUI3X.js');
var chunk4FIMMGNT_js = require('./chunk-4FIMMGNT.js');
var chunk7S25MALX_js = require('./chunk-7S25MALX.js');
...
var StyledProcessor = class extends chunk7S25MALX_js.BaseProcessor {
  constructor(params, ...args) {
    var _a;
    if (params.length <= 2) {
      throw chunk7S25MALX_js.BaseProcessor.SKIP;
    }
    super([params[0]], ...args);
    this.variableIdx = 0;
    this.finalVariants = [];
  ...
  buildTemplateTag(templateStrs, templateExpressions, values) {
    const cssClassName = chunk4FIMMGNT_js.css(templateStrs, ...templateExpressions);
    const cssText = chunk4FIMMGNT_js.cache.registered[cssClassName];
  ...
  doRuntimeReplacement() {
    ...
    if (this.collectedVariants.length) {
      argProperties.push(
        t.objectProperty(t.identifier("variants"), chunkY7JG2JA7_js.valueToLiteral(this.collectedVariants))
      );
    }
  ...
  processCss(styleObjOrFn, styleArg, variantsAccumulator, themeImportIdentifier) {
    ...
    if (styleObj.variants) {
      variantsAccumulator == null ? void 0 : variantsAccumulator.push(
        ...styleObj.variants.map((variant) => chunk7S25MALX_js.__spreadProps(chunk7S25MALX_js.__spreadValues({}, variant), {
    ...
    const res = chunkDVVUUI3X_js.cssFnValueToVariable({
      styleObj,
    ...
    return chunkDVVUUI3X_js.processCssObject(styleObj, themeArgs);
  }
  get asSelector() {
