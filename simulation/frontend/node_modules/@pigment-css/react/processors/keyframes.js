...
var KeyframesProcessor = class extends chunk7S25MALX_js.BaseProcessor {
  ...
  generateArtifacts(styleObjOrTaggged, ...args) {
    ...
    const { styles } = serialize.serializeStyles(
      ...
      chunk4FIMMGNT_js.cache.registered
    );
