...
var chunkAPX52WPF_js = require('./chunk-APX52WPF.js');
...
var hiddenAtomics = chunkAPX52WPF_js.generateAtomics(({ theme }) => {
  const conditions = {};
...
var Hidden = React__namespace.forwardRef(function Hidden2(_a, ref) {
  var _b = _a, { className, component = "div", style } = _b, props = chunkSKBER3MM_js.__objRest(_b, ["className", "component", "style"]);
  const other = {};
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Component,
    chunkSKBER3MM_js.__spreadValues({
      ref,
      className: clsx__default.default(stackClasses.className, className),
      style: chunkSKBER3MM_js.__spreadValues(chunkSKBER3MM_js.__spreadValues({}, style), stackClasses.style)
    }, other)
  );
});
if (process.env.NODE_ENV !== "production") {
  Hidden.propTypes = {
     ...
     */
    only: PropTypes__default.default.oneOfType([
      PropTypes__default.default.oneOf(["xs", "sm", "md", "lg", "xl"]),
      PropTypes__default.default.arrayOf(PropTypes__default.default.oneOf(["xs", "sm", "md", "lg", "xl"]))
    ]),
    /**
     * If `true`, screens this size and down are hidden.
     */
