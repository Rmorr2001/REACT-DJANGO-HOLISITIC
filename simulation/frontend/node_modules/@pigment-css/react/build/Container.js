...
var ContainerRoot = chunk346ZYU45_js.styled("div", {
  name: "MuiContainer",
  slot: "Root"
})(({ theme }) => ({
  width: "100%",
...
var Container = React__namespace.forwardRef(function Container2(props, ref) {
  const _a = props, {
    ...
    fixed = false,
    maxWidth = "lg"
  } = _a, other = chunkSKBER3MM_js.__objRest(_a, [
    "className",
    "component",
    "disableGutters",
    "fixed",
  ...
  const ownerState = chunkSKBER3MM_js.__spreadProps(chunkSKBER3MM_js.__spreadValues({}, props), {
    component,
    disableGutters,
    fixed,
    maxWidth
