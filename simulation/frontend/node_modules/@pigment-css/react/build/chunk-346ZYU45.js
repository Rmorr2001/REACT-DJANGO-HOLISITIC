...
var chunkSKBER3MM_js = require('./chunk-SKBER3MM.js');
...
function getVariantClasses(_a, variants) {
  var _b = _a, { ownerState = {} } = _b, componentProps = chunkSKBER3MM_js.__objRest(_b, ["ownerState"]);
  const variantClasses = variants.filter(
    ({ props: variantProps }) => typeof variantProps === "function" ? variantProps(chunkSKBER3MM_js.__spreadProps(chunkSKBER3MM_js.__spreadValues(chunkSKBER3MM_js.__spreadValues({}, componentProps), ownerState), { ownerState })) : Object.entries(variantProps).every(([propKey, propValue]) => {
...
function styled(tag, componentMeta = {}) {
  ...
  function scopedStyledWithOptions(options = {}) {
    ...
    const StyledComponent = React__namespace.forwardRef(function StyledComponent2(inProps, ref) {
      const _a = inProps, { className, sx, style, ownerState } = _a, props = chunkSKBER3MM_js.__objRest(_a, ["className", "sx", "style", "ownerState"]);
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        Component,
        chunkSKBER3MM_js.__spreadProps(chunkSKBER3MM_js.__spreadValues(chunkSKBER3MM_js.__spreadValues({}, newProps), Component.__styled_by_pigment_css && { ownerState }), {
          ref,
          className: finalClassName,
          style: chunkSKBER3MM_js.__spreadValues(chunkSKBER3MM_js.__spreadValues({}, varStyles), style)
        })
      );
    });
...
//# sourceMappingURL=chunk-346ZYU45.js.map
//# sourceMappingURL=chunk-346ZYU45.js.map