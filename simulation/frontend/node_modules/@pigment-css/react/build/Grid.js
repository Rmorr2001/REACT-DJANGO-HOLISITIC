...
var chunk346ZYU45_js = require('./chunk-346ZYU45.js');
...
var gridAtomics = chunkAPX52WPF_js.generateAtomics(({ theme }) => {
...
var GridComponent = chunk346ZYU45_js.styled("div")({
...
var Grid = React__namespace.forwardRef(function Grid2(_a, ref) {
  var _b = _a, {
    ...
    wrap = "wrap"
  } = _b, other = chunkSKBER3MM_js.__objRest(_b, [
    "children",
    "columns",
    "spacing",
    "columnSpacing",
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    GridComponent,
    chunkSKBER3MM_js.__spreadProps(chunkSKBER3MM_js.__spreadValues({
      as: component,
      ref,
      className: clsx__default.default(gridClasses.className, className),
      style: chunkSKBER3MM_js.__spreadValues(chunkSKBER3MM_js.__spreadValues({}, style), gridClasses.style)
    }, other), {
      ownerState,
