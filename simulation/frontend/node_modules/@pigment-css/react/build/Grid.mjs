import { styled } from './chunk-S3TWMEL6.mjs';
import { generateAtomics } from './chunk-ZQGEJBQA.mjs';
import { __objRest, __spreadProps, __spreadValues } from './chunk-7HZ7L36E.mjs';
...
var gridAtomics = generateAtomics(({ theme }) => {
...
var Grid = React.forwardRef(function Grid2(_a, ref) {
  var _b = _a, {
    children,
    columns,
    spacing,
  ...
  return /* @__PURE__ */ jsx(
    ...
    __spreadProps(__spreadValues({
      ...
      style: __spreadValues(__spreadValues({}, style), gridClasses.style)
    }, other), {
      ownerState,
