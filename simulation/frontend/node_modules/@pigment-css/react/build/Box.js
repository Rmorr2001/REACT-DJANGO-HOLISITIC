...
var Box = React__namespace.forwardRef(
  (_a, ref) => {
    ...
    const styles = chunkSKBER3MM_js.__spreadValues(chunkSKBER3MM_js.__spreadValues({}, style), varStyles);
    return /* @__PURE__ */ jsxRuntime.jsx(Component, chunkSKBER3MM_js.__spreadValues({ ref, className: classes, style: styles }, other));
  }
);
process.env.NODE_ENV !== "production" ? Box.propTypes = {
   ...
   */
  sx: PropTypes__default.default.oneOfType([PropTypes__default.default.func, PropTypes__default.default.object])
} : void 0;
var Box_default = Box;
